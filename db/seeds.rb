...
users = User.create!(
  [
    {company_name: "星空不動産㈱", location: "東京都千代田区有楽町０―０―０", licensing_entity: "国土交通大臣", licensing_region: , update_number: 1, license_number: 999999,
...
Property.create!(
  [
    ...
    {user_id: users[2].id, kind: "区分マンション", right: "所有権", building_name: "レシェール代官山", prefecture: "東京都", municipality: "渋谷区", city_block: "鴬谷町", address: "０－０", line: "東急東横線", station: "代官山駅",
